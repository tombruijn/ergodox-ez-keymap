...
[BASE] = KEYMAP(
        ...
        KC_GRV,         KC_NO,        KC_LALT,LT(MNGM, KC_NO), KC_LGUI,
        ...
        MEH_T(KC_NO),KC_N,   KC_M,   KC_COMM,KC_DOT, CTL_T(KC_SLSH),   KC_RSFT,
                             LT(SYMB, KC_NO), LT(MNGM, KC_NO), KC_LALT,KC_LBRC,          KC_RBRC,

        KC_LALT,      CTL_T(KC_ESC),
        KC_PGUP,
        ALL_T(KC_NO), KC_LALT, KC_ENT
    ),
